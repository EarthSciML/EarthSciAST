...
PLANNED = [
    ...
    },
    {
        ...
        "one letter and mean different things.",
        "resolution": "API_SPEC.md §8 item 22: rename to `Rhs::{Auto, Always, Never}` "
        "(working proposal), keeping `Compile` as a deprecated alias for one "
        "minor.",
        "affects": ["rust"],
    },
    {
