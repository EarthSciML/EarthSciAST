...
describe('AST Store', () => {
  ...
  describe('PathUtils', () => {
    it('converts strings to paths', () => {
      ...
      expect(PathUtils.fromString('components.Chemistry.variables')).toEqual([
        'components',
        'Chemistry',
        'variables',
      ])
    ...
    it('converts paths to strings', () => {
      ...
      expect(PathUtils.toString(['components', 'Chemistry', 'variables'])).toBe(
        'components.Chemistry.variables',
      )
  ...
  describe('CommonPaths', () => {
    ...
    it('provides model paths', () => {
      ...
      expect(CommonPaths.modelVariable('Chemistry', 'O3')).toEqual([
        'models',
        'Chemistry',
        'variables',
        'O3',
      ...
      expect(CommonPaths.modelEquation('Chemistry', 2)).toEqual([
        'models',
        'Chemistry',
        'equations',
        2,
    ...
    it('provides reaction system paths', () => {
      ...
      expect(CommonPaths.reactionSpecies('Reactions')).toEqual([
        'reaction_systems',
        'Reactions',
        'species',
      ])
      expect(CommonPaths.reactionSpeciesEntry('Reactions', 'O3')).toEqual([
        'reaction_systems',
        'Reactions',
        'species',
        'O3',
      ])
      expect(CommonPaths.reactions('Reactions')).toEqual([
        'reaction_systems',
        'Reactions',
        'reactions',
      ])
      expect(CommonPaths.reaction('Reactions', 0)).toEqual([
        'reaction_systems',
        'Reactions',
        'reactions',
        0,
