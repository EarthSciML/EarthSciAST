...
describe('Fraction component', () => {
  it('renders basic fraction with numerator and denominator', () => {
    const { container } = render(() => (
      <Fraction numerator={<span>x</span>} denominator={<span>y</span>} />
    ))
  ...
  it('applies custom CSS classes', () => {
    const { container } = render(() => (
      <Fraction class="custom-fraction" numerator={<span>1</span>} denominator={<span>2</span>} />
    ))
  ...
  it('handles inline property correctly', () => {
    const { container } = render(() => (
      <Fraction inline={true} numerator={<span>1</span>} denominator={<span>2</span>} />
    ))
  ...
  it('can disable inline mode', () => {
    const { container } = render(() => (
      <Fraction inline={false} numerator={<span>1</span>} denominator={<span>2</span>} />
    ))
  ...
  it('has proper accessibility attributes', () => {
    const { container } = render(() => (
      <Fraction numerator={<span>a</span>} denominator={<span>b</span>} />
    ))
