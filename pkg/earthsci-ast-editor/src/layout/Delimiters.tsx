...
export const Delimiters: Component<DelimitersProps> = (props) => {
  ...
  return (
    ...
    >
      <span class="esm-delimiters-left">{getDelimiterChars().left}</span>
      <span class="esm-delimiters-content">{props.content}</span>
      <span class="esm-delimiters-right">{getDelimiterChars().right}</span>
    </span>
  )
}
