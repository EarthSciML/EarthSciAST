...
const OP_FIELD_SPECS: Record<string, OpFieldSpec[]> = {
  ...
  reshape: [
    { name: 'shape', label: 'Shape', type: 'mixedlist', placeholder: '2, 3 or ["m", "n"]' },
  ],
  transpose: [
    {
      name: 'perm',
      label: 'Permutation (optional)',
      type: 'intlist',
      optional: true,
      placeholder: '1, 0',
    },
  ...
  intersect_polygon: [
    { name: 'manifold', label: 'Manifold', type: 'select', options: MANIFOLD_OPTIONS },
  ],
...
type ParseResult = { value: unknown } | { omit: true } | { error: string }
