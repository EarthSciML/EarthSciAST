...
mod tests {
    ...
    fn basic_enum_replaced_with_const() {
        ...
        let expr = crate::classification::observed_definition_json(&out["models"]["M"], "s")
            .expect("s defining equation");
    ...
    fn nested_enum_in_index_op() {
        ...
        let out = lowered(input);
        let expr = crate::classification::observed_definition_json(&out["models"]["M"], "r")
            .expect("r defining equation");
    ...
    fn enum_op_in_subsystem_blob() {
        ...
        let out = lowered(input);
        let expr = crate::classification::observed_definition_json(
            &out["models"]["Outer"]["subsystems"]["Inner"],
            "y",
        )
