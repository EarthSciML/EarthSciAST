...
Each shared fixture under ``tests/valid/faq/`` that carries inline
...
_INVALID_FIXTURES_DIR = INVALID_DIR / "faq"
...
_BUILD_TIME_INVALID_DIR = INVALID_DIR / "faq" / "build_time"
...
def test_build_time_invalid_fixture_rejected(fixture_path: Path) -> None:
    """Every ``tests/invalid/faq/build_time/`` fixture is SCHEMA-valid and
