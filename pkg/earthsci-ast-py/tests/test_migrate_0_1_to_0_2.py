...
Covers ``earthsci_ast.migration.migrate_file_0_1_to_0_2`` (pure dict
transform) and the ``esm-migrate`` CLI (``earthsci_ast.cli.migrate``).
...
from earthsci_ast.cli import migrate as cli_migrate
from earthsci_ast.migration import migrate_file_0_1_to_0_2
