...
import pytest
import sympy as sp
from earthsci_ast.expression import (
    free_variables,
    free_parameters,
    contains,
    simplify,
...
class TestPublicEvaluate:
    """Unit tests for the public ``earthsci_ast.evaluate`` entry point.
    ...
    def test_import_from_package(self):
        from earthsci_ast import evaluate
    ...
    def test_unbound_variable_raises(self):
        from earthsci_ast import evaluate
        from earthsci_ast.numpy_interpreter import NumpyInterpreterError
