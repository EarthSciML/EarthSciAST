...
The official ESS Python simulation runner (earthsci_ast.simulation) has
...
from earthsci_ast.simulation import SimulationError
...
class TestAbs:
    def test_abs_positive(self, symbol_map, x_sym):
        ...
        from earthsci_ast.sympy_bridge import _ess_numeric_abs
