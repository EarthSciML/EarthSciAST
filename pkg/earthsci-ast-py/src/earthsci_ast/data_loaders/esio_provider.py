...
ESS keeps its in-tree :class:`~earthsci_ast.data_loaders.provider.LoadDataProvider`
...
addressed cache (+ CDS, etc.)::
    ...
    from earthsci_ast.data_loaders.esio_provider import esio_provider_factory
