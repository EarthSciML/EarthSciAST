...
def _collect_model(
    ...
    # The namespacing scope, hoisted ABOVE the variable loop because a
    # parameter's `update` expressions are namespaced inside it (they are
    # ordinary references in this component's scope). Otherwise exactly the
    # scope `_namespace_equations` uses below.
    #
