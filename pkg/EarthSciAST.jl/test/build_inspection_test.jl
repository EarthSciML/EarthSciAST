...
function _bi_regrid_doc()
    ...
    Dict{String,Any}(
        ...
        # esm 1.0.0 (§5.4/§6.3.1): a variable has NO `expression`. Every observed
        # here is a plain `unknown` DEFINED by a bare-variable-LHS equation.
        "models" => Dict{String,Any}("Regrid" => Dict{String,Any}(
            "variables" => Dict{String,Any}(
                "atol" => Dict("type" => "parameter", "units" => "1", "default" => 1e-12),
                "src_poly" => Dict("type" => "unknown",
                    "shape" => Any["src_cells", "verts", "coord"]),
                "tgt_poly" => Dict("type" => "unknown",
                    "shape" => Any["tgt_cells", "verts", "coord"]),
                "A_ij" => Dict("type" => "unknown",
                    "shape" => Any["src_cells", "tgt_cells"]),
                "A_j" => Dict("type" => "unknown", "shape" => Any["tgt_cells"]),
                "W_ij" => Dict("type" => "unknown",
                    "shape" => Any["src_cells", "tgt_cells"]),
                "x" => Dict("type" => "unknown", "default" => 0.0)),
            "equations" => Any[
                Dict{String,Any}("lhs" => "src_poly",
                    "rhs" => Dict("op" => "const", "args" => Any[], "value" => _BI_SRC)),
                Dict{String,Any}("lhs" => "tgt_poly",
                    "rhs" => Dict("op" => "const", "args" => Any[], "value" => _BI_TGT)),
                Dict{String,Any}("lhs" => "A_ij",
                    "rhs" => _bi_agg(Any["i", "j"], ranges_ij,
                        Dict{String,Any}("op" => "polygon_intersection_area",
                            "manifold" => "planar",
                            "args" => Any[_bi_index("src_poly", "i"),
                                          _bi_index("tgt_poly", "j")]);
                        args=Any["src_poly", "tgt_poly"])),
                Dict{String,Any}("lhs" => "A_j",
                    "rhs" => _bi_agg(Any["j"], ranges_ij,
                        _bi_index("A_ij", "i", "j"); filter=sliver, args=Any["A_ij"])),
                Dict{String,Any}("lhs" => "W_ij",
                    "rhs" => _bi_agg(Any["i", "j"], ranges_ij,
                        Dict{String,Any}("op" => "/",
...
function _bi_ragged_doc()
    ...
    Dict{String,Any}(
        ...
        # esm 1.0.0: the const factors, the bare-name alias and `div` are all
        # `unknown`s whose DEFINING equation carries what used to be `expression`.
        "models" => Dict{String,Any}("Div" => Dict{String,Any}(
            "variables" => Dict{String,Any}(
                "nEdgesOnCell" => Dict("type" => "unknown", "shape" => Any["cells"]),
                "edgesOnCell" => Dict("type" => "unknown", "shape" => Any["cells", "maxE"]),
                "sgn" => Dict("type" => "unknown", "shape" => Any["cells", "maxE"]),
                "F0" => Dict("type" => "unknown", "shape" => Any["edges"]),
                "F" => Dict("type" => "unknown", "shape" => Any["edges"],
                    "description" => "bare-name alias of the const factor (keyed-factor re-exposure)"),
                "div" => Dict("type" => "unknown", "shape" => Any["cells"]),
                "u" => Dict("type" => "unknown", "shape" => Any["cells"], "default" => 0.0)),
            "equations" => Any[
                Dict{String,Any}("lhs" => "nEdgesOnCell",
                    "rhs" => Dict("op" => "const", "args" => Any[], "value" => Any[2, 3])),
                Dict{String,Any}("lhs" => "edgesOnCell",
                    "rhs" => Dict("op" => "const", "args" => Any[],
                                  "value" => Any[Any[1, 2, 0], Any[3, 1, 2]])),
                Dict{String,Any}("lhs" => "sgn",
                    "rhs" => Dict("op" => "const", "args" => Any[],
                                  "value" => Any[Any[1, -1, 0], Any[1, 1, -1]])),
                Dict{String,Any}("lhs" => "F0",
                    "rhs" => Dict("op" => "const", "args" => Any[],
                                  "value" => Any[10.0, 20.0, 30.0])),
                Dict{String,Any}("lhs" => "F", "rhs" => "F0"),
                Dict{String,Any}("lhs" => "div", "rhs" => div_expr),
                Dict{String,Any}(
