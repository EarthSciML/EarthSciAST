...
@testset "Display Tests" begin
    ...
    @testset "Utility Functions" begin
        # Test to_superscript
        @test EarthSciAST.to_superscript("1") == "¹"
        @test EarthSciAST.to_superscript("23") == "²³"
        @test EarthSciAST.to_superscript("-1") == "⁻¹"
        @test EarthSciAST.to_superscript("+2") == "⁺²"

        # Test has_element_pattern
        @test EarthSciAST.has_element_pattern("H2O") == true
        @test EarthSciAST.has_element_pattern("CO2") == true
        @test EarthSciAST.has_element_pattern("NH3") == true
        @test EarthSciAST.has_element_pattern("xyz") == false
        @test EarthSciAST.has_element_pattern("temp") == false
        @test EarthSciAST.has_element_pattern("H") == true
        @test EarthSciAST.has_element_pattern("He") == true

        # Non-ASCII names must not throw StringIndexError
        @test EarthSciAST.has_element_pattern("α2") == false
        @test EarthSciAST.has_element_pattern("αH2O") == true
        @test EarthSciAST.has_element_pattern("θ") == false
    end

    @testset "Chemical Formula Formatting" begin
        # Test format_chemical_subscripts for unicode
        @test EarthSciAST.format_chemical_subscripts("H2O", :unicode) == "H₂O"
        @test EarthSciAST.format_chemical_subscripts("CO2", :unicode) == "CO₂"
        @test EarthSciAST.format_chemical_subscripts("CH4", :unicode) == "CH₄"
        ...
        @test EarthSciAST.format_chemical_subscripts("H2O", :ascii) == "H2O"   # No subscripts in ASCII
        @test EarthSciAST.format_chemical_subscripts("CO2", :ascii) == "CO2"   # No subscripts in ASCII
        @test EarthSciAST.format_chemical_subscripts("NH3", :ascii) == "NH3"   # No subscripts in ASCII
        @test EarthSciAST.format_chemical_subscripts("temp", :ascii) == "temp" # Non-chemical variable unchanged

        # Non-ASCII names must not throw and pass through / subscript correctly
        @test EarthSciAST.format_chemical_subscripts("α2", :unicode) == "α2"
        @test EarthSciAST.format_chemical_subscripts("αH2O", :unicode) == "αH₂O"
        @test EarthSciAST.format_chemical_subscripts("α2", :ascii) == "α2"
    end
    ...
    @testset "Number Formatting" begin
        ...
        @test EarthSciAST.format_number(3.14, :latex) == "3.14"
        @test EarthSciAST.format_number(1.0, :latex) == "1"  # Julia formats 1.0 as "1"
        @test EarthSciAST.format_number(-2.5, :latex) == "-2.5"
    end

    @testset "Operator Precedence" begin
        # Test get_operator_precedence - check actual values in the implementation
        @test EarthSciAST.get_operator_precedence("+") == 4
        @test EarthSciAST.get_operator_precedence("-") == 4
        @test EarthSciAST.get_operator_precedence("*") == 5
        @test EarthSciAST.get_operator_precedence("/") == 5
        @test EarthSciAST.get_operator_precedence("^") == 7
        @test EarthSciAST.get_operator_precedence("pow") == 8  # Based on error output
        @test EarthSciAST.get_operator_precedence("sin") == 8
        @test EarthSciAST.get_operator_precedence("unknown") == 8  # Unknown operators get default precedence
    end
    ...
    @testset "Parentheses Logic" begin
        ...
        @test EarthSciAST.needs_parentheses("+", mul_expr, false) == false  # y*z + ...
        @test EarthSciAST.needs_parentheses("-", add_expr, true) == true    # ... - (1 + x)
        @test EarthSciAST.needs_parentheses("*", mul_expr, false) == false  # y*z * ...
    end
    ...
    @testset "Expression Formatting" begin
        ...
        @test EarthSciAST.format_expression_unicode(num_expr) == "3.14"
        @test EarthSciAST.format_expression_latex(num_expr) == "3.14"

        # Test VarExpr formatting
        var_expr = VarExpr("x")
        @test EarthSciAST.format_expression_unicode(var_expr) == "x"
        @test EarthSciAST.format_expression_latex(var_expr) == "x"
    ...
    @testset "Model and ReactionSystem Display" begin
        ...
        rs = ReactionSystem(
            ...
            [Reaction("r1",
                      ...
                      [EarthSciAST.StoichiometryEntry("B", 1)],
                      VarExpr("k"))];
    ...
    @testset "min/max render as function calls for any arity" begin
        ...
        @test EarthSciAST.format_expression_ascii(two) == "max(a, b)"
        @test EarthSciAST.format_expression_latex(two) == "\\max(a, b)"
        @test EarthSciAST.format_expression_unicode(three) == "min(a, b, c)"
    end
