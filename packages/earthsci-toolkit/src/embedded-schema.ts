    ...
    "CrossMetricStencilRule": {
      ...
      "properties": {
        ...
        "grid_family": {
          ...
          "description": "Grid family this composite targets. In practice cross-metric composites are primarily used on curvilinear grids; 'cartesian' is a conformance-friendly degenerate case where off-diagonal metric components vanish."
        },
        "axes": {
          "type": "array",
          "minItems": 1,
    ...
    "MultiOutputStencilRule": {
      ...
      "properties": {
        "kind": {
          ...
          "description": "Discriminator for bindings that need to distinguish this rule type from a standard Discretization or CrossMetricStencilRule. Optional (presence of `outputs` plus an object-valued `stencil` is sufficient), but recommended for statically-typed bindings."
        },
        "applies_to": {
