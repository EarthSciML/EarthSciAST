...
adapters (:mod:`~earthsci_toolkit.cli.determinism_adapter`,
:mod:`~earthsci_toolkit.cli.cadence_adapter`,
:mod:`~earthsci_toolkit.cli.pde_simulation_adapter`) keep only their
per-fixture logic.
