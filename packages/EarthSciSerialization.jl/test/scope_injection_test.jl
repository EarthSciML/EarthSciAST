...
@testset "scope-directed template injection (esm-spec §9.7.10)" begin
    ...
    @testset "form A — subsystem-ref injection (§4.7 / §9.7.10)" begin
        f = EarthSciSerialization.load(conf("inject_subsystem_ref", "fixture.esm"))
        ...
        @test runoff isa EarthSciSerialization.Model
        ...
        leaf = EarthSciSerialization.load(conf("inject_subsystem_ref", "leaf.esm"))
        ...
        ni = EarthSciSerialization.load(conf("inject_subsystem_ref", "no_inject.esm"))
        @test ni.models["Assembly"].subsystems["Runoff"] isa EarthSciSerialization.Model
    ...
    @testset "form B — coupling-entry injection (§10.8 / §9.7.10)" begin
        f = EarthSciSerialization.load(conf("inject_coupling_entry", "fixture.esm"))
        ...
        # Diagnostics.
        @test _err_code(() -> EarthSciSerialization.load(
    ...
    @testset "form C — test/example injection (§6.6.6 / §9.7.10)" begin
        f = EarthSciSerialization.load(conf("inject_test_block", "fixture.esm"))
