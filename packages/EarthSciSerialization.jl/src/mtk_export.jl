...
mtk2esm(sys; kwargs...) = throw(ArgumentError(
    ...
    "Symbolics and DomainSets) to activate EarthSciSerializationMTKExt, or " *
    "Catalyst to activate EarthSciSerializationCatalystExt, then retry"))
...
mtk2esm_gaps(sys) = throw(ArgumentError(
    ...
    "Symbolics and DomainSets) to activate EarthSciSerializationMTKExt, " *
    "then retry"))

# ========================================
# MTK-independent export helpers
# ========================================
# Shared by EarthSciSerializationMTKExt and EarthSciSerializationCatalystExt
