...
//!
//! - `pde-tests`   [`earthsci_toolkit::pde_inline_tests::run_pde_tests`] —
//!   the §6.6/§6.6.5 inline tests through [`earthsci_toolkit::simulate`].
//! - `convergence` [`earthsci_toolkit::parse::load_path_with_options`] once
...
use earthsci_toolkit::parse::{LoadOptions, load_path, load_path_with_options, load_with_options};
...
fn cmd_convergence(
    ...
    for res in &resolutions {
        ...
        let reference_field = evaluate_cellwise(&reference, &cell_tuples, &index_sets)?;
