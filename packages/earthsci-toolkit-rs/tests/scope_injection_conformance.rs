...
//! (`EarthSciSerialization.jl/test/scope_injection_test.jl`), driving the shared
//! conformance fixtures under `tests/conformance/expression_templates/` against
//! the Julia-generated goldens.

use earthsci_toolkit::pde_inline_tests::ephemeral_injected_file;
use earthsci_toolkit::{load_path, save};
